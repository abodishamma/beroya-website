...
dictionary.en.account = {
  ...
  messages: {
    missing: "Please add the required email and name fields.",
    verificationSent: "We sent a secure verification link to your email. Open it to finish signing in.",
    backendMissing: "Email verification is being configured. Please try again shortly.",
    authFailed: "We could not send the verification email. Please check the address and try again.",
    registered: "Check your email to verify your account.",
    updated: "Check your email to finish signing in.",
...
dictionary.ar.account = {
  ...
  messages: {
    missing: "أضف حقول البريد الإلكتروني والاسم المطلوبة.",
    verificationSent: "أرسلنا رابط تحقق آمن إلى بريدك الإلكتروني. افتحه لإكمال تسجيل الدخول.",
    backendMissing: "نظام التحقق بالبريد قيد الإعداد. حاول مرة أخرى بعد قليل.",
    authFailed: "تعذر إرسال رسالة التحقق. تأكد من البريد الإلكتروني وحاول مرة أخرى.",
    registered: "راجع بريدك الإلكتروني لتأكيد الحساب.",
    updated: "راجع بريدك الإلكتروني لإكمال تسجيل الدخول.",
